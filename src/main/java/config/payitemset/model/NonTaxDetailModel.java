...
public class NonTaxDetailModel {
	...
	public NonTaxDetailModel() {

	}

	public NonTaxDetailModel(Integer nonTaxId, Integer companyId, String legalProvision, String legalCode,
