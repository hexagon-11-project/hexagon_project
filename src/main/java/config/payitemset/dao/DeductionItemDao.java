...
import config.payitemset.model.DeductionItemModel;

public class DeductionItemDao {

	public List<DeductionItemModel> selectByCompanyId(Connection conn, int companyId) throws SQLException {
		...
		try {
			...
			List<DeductionItemModel> result = new ArrayList<>();
	...
	private DeductionItemModel mapRow(ResultSet rs) throws SQLException {

		DeductionItemModel item = new DeductionItemModel();
