...
<head>
<meta charset="UTF-8">
<title>급여내역 조회 사원선택 | HEXAGON PAY</title>
<style>
...
<body>
    ...
    <div class="modal-header">급여내역 조회 사원선택</div>
    ...
    <form id="empSearchForm" action="${pageContext.request.contextPath}/Payment/paymentPayListEmployeeModal.do" method="GET" onsubmit="return validateSearch()">
        <div class="search-bar">
            <div class="search-input-group">
                ...
                <button type="button" class="btn-view-all" onclick="location.href='${pageContext.request.contextPath}/Payment/paymentPayListEmployeeModal.do'">전체보기</button>
            </div>
    ...
    <div style="text-align: center; margin-top: 15px;">
        <c:if test="${currentPage > 1}">
            <a href="${pageContext.request.contextPath}/Payment/paymentPayListEmployeeModal.do?page=${currentPage - 1}&empName=${empName}&department=${selectedDept}&status=${selectedStatus}" style="text-decoration:none; color:black; margin-right:10px;">◀ 이전</a>
        </c:if>
        ...
        <c:if test="${currentPage < totalPage}">
            <a href="${pageContext.request.contextPath}/Payment/paymentPayListEmployeeModal.do?page=${currentPage + 1}&empName=${empName}&department=${selectedDept}&status=${selectedStatus}" style="text-decoration:none; color:black; margin-left:10px;">다음 ▶</a>
        </c:if>
    </div>
